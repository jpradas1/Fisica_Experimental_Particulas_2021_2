...
void ttbar_MC2_macro (){
    ...
    for (i = 0; i < nentries; i++){
        ...
        //All histograms
        hist_lept_pt->Fill(lep_pt[g_lep]/1000 , evtw);
        hist_lept_pt_cone30->Fill(lep_ptcone30[g_lep] / lep_pt[g_lep] , evtw);
        hist_lept_et_cone20->Fill(lep_etcone20[g_lep] / lep_pt[g_lep] , evtw);
        hist_lept_eta->Fill(lep_eta[g_lep] , evtw);
        
        hist_njets->Fill(jet_n , evtw);
        
        hist_jets_pt-> Fill(jet_pt[0]/1000 , evtw);
        hist_jets_eta-> Fill(jet_eta[0] , evtw);
        hist_jets_jvf-> Fill(jet_jvf[0] , evtw);
        hist_jets_mv1-> Fill(jet_mv1[0] , evtw);
    ...
    cutflow->Draw("");
    canvas-> Print("HGraphsMC2/cutflow.png");
    canvas->Clear();
    ...
    hist_nbjets->Draw();
    canvas->Print("HGraphsMC2/hist_nbjets.png");
    canvas->Clear();
    ...
    hist_MET->Draw();
    canvas->Print("HGraphsMC2/hist_MET.png");
    canvas->Clear();
    ...
    hist_mTW->Draw();
    canvas->Print("HGraphsMC2/hist_mTW.png");
    canvas->Clear();
